...
public class MTSeparator9x9 extends ModularTurbineBlockBase {
	public MTSeparator9x9(String s) {
		super(s);
	}
	@Override
	...
	protected void fillSpace(World world,int x,int y,int z,ForgeDirection dir,int o) {
		...
		x += dir.offsetX * o;
		z += dir.offsetZ * o;
		MultiblockHandlerXR.fillSpace(world,x,y,z,new int[]{8,-8,0,0,3,3},this,dir);
	}
	@Override
	public boolean checkRequirement(World world,int x,int y,int z,ForgeDirection dir,int o) {
		x += dir.offsetX * o;
		z += dir.offsetZ * o;
		if (!MultiblockHandlerXR.checkSpace(world,x,y,z,new int[]{8,-8,0,0,3,3},x,y,z,dir))
			return false;
