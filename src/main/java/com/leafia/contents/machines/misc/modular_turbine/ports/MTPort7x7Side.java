...
public class MTPort7x7Side extends MTSeparator7x7 implements IMTPortBlock {
	public MTPort7x7Side(String s) {
		super(s);
	}
	@Override
	public DirPos[] getConPos(BlockPos pos,EnumFacing facing) {
		return new DirPos[]{
				new DirPos(pos.offset(facing.rotateY(),4),ForgeDirection.getOrientation(facing.rotateY())),
				new DirPos(pos.offset(facing.rotateY(),-4),ForgeDirection.getOrientation(facing.rotateY().getOpposite()))
		};
	}
	@Override
	...
	protected void fillSpace(World world,int x,int y,int z,ForgeDirection dir,int o) {
		...
		makeExtra(world,x+rot.getXOffset()*3,y,z+rot.getZOffset()*3);
		makeExtra(world,x-rot.getXOffset()*3,y,z-rot.getZOffset()*3);
	}
}
