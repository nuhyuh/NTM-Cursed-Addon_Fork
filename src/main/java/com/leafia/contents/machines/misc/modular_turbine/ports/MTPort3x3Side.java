...
public class MTPort3x3Side extends MTSeparator3x3 implements IMTPortBlock {
	public MTPort3x3Side(String s) {
		super(s);
	}
	@Override
	public DirPos[] getConPos(BlockPos pos,EnumFacing facing) {
		return new DirPos[]{
				new DirPos(pos.offset(facing.rotateY(),2),ForgeDirection.getOrientation(facing.rotateY())),
				new DirPos(pos.offset(facing.rotateY(),-2),ForgeDirection.getOrientation(facing.rotateY().getOpposite()))
		};
	}
	@Override
	...
	protected void fillSpace(World world,int x,int y,int z,ForgeDirection dir,int o) {
		...
		makeExtra(world,x+rot.getXOffset(),y,z+rot.getZOffset());
		makeExtra(world,x-rot.getXOffset(),y,z-rot.getZOffset());
	}
}
