...
public class MTPort9x9Top extends MTSeparator9x9 implements IMTPortBlock {
	public MTPort9x9Top(String s) {
		super(s);
	}
	@Override
	public DirPos[] getConPos(BlockPos pos,EnumFacing facing) {
		return new DirPos[]{
				new DirPos(pos.up(9),ForgeDirection.UP)
		};
	}
	@Override
